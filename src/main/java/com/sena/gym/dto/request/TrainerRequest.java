...
/** DTO para crear o actualizar entrenadores. */
public record TrainerRequest(
    ...
    @Size(min=3, max=100, message="La especialidad debe tener entre 3 y 100 caracteres") String specialty,
    @NotBlank(message="El celular es obligatorio")
    @Pattern(regexp="^\\d{10,12}$", message="El celular debe tener solo numeros y entre 10 y 12 digitos") String phone,
    @NotBlank(message="El correo es obligatorio") @Email(message="El correo debe tener formato valido")
